...
<!--    <button v-on:click="testAdd">ew</button>-->
    ...
    <div class="columns is-mobile is-multiline">
      <div class="column is-full-mobile is-one-quarter-desktop">
        <pictorial-menu-item-creator :sampleId="id" v-on:add-item="addItem" :form-name="'uploader1'" :icon-property-name="'icon'">
...
<script lang="js">
  ...
  export default {
    ...
    created: function () {
      try {
        this.$axios.get(this.remoteServer + '/api/sample/sessions/' + this.id, {headers: {}})
          .then((response) => {
