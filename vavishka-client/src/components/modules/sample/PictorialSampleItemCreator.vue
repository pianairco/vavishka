    ...
    <div class="card-content">
      <div class="media" style="padding-top: 15px;">
        <div class="media-content">
          <div class="field">
            <div class="control">
              <input class="input is-primary" type="text" v-model="item.title" placeholder="عنوان">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="content">
        <textarea class="textarea" placeholder="توضیحات" v-model="item.description" rows="2"></textarea>
      </div>
    </div>
